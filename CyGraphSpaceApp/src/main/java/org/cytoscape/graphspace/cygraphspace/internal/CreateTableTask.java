...
public class CreateTableTask extends AbstractTask {
	...
	public void run(TaskMonitor tm) throws IOException {
		CyTableManager tableManager = CyObjectManager.INSTANCE.getTableManager();
		CyTable table = tableFactory.createTable("CyGraphSpaceTable", "name", String.class, true, true);
