...
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.COLUMN_NAME;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.COLUMN_TYPES;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.DATA;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.EDGE;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.EDGES;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.ELEMENTS;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.ID;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.LIST_TYPE;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.NETWORK;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.NODE;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.NODES;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.POSITION;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.POSITION_X;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.POSITION_Y;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.SOURCE;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.TARGET;
import static org.cytoscape.graphspace.cygraphspace.internal.io.write.json.serializer.CytoscapeJsToken.TYPE;
 ...
 * 
 */
public class CustomCytoscapejsMapper {
	...
	/**
	 * 
	 * Read element list generated by cy.elements().jsons() method in Cytoscape.js
	 * 
	 * @param rootNode
	 * @param network
	 ...
	 * 
	 */
	public CyNetwork createNetworkFromElementList(final JsonNode rootNode, final CyNetwork network, final String collectionName) {
		if(rootNode.isArray() == false) {
			throw new IllegalArgumentException("Element list should be an JSON array.");
		}
		
		final JsonNode elements = rootNode;
		
		// Create node/edge list
		final ArrayNode nodes = new ArrayNode(new JsonNodeFactory(false));
		final ArrayNode edges = new ArrayNode(new JsonNodeFactory(false));
		StreamSupport.stream(elements.spliterator(), false)
			.forEach(element->addElement(nodes, edges, element));
	...
	private final void addElement(final ArrayNode nodes, final ArrayNode edges, final JsonNode node) {
		JsonNode group = node.get("group");
		if(group == null) {
			return;
		}
		
		final String elementType = group.textValue();
